...
\033[1;37m  		   ╚╩═╩╝╚══╝╚╩═╝╚╝╚╝╚╝╚╝╚═╝ 	  
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            MD MINHAJ HOSSAIN 
\033[1;37m Facebook:            Minhaj Hossain 
\033[1;37m Github  :            minhajhossain43
...
def sarfraz():   
    ...
    print(f'[W] My Github ')
    print(f'[F] Follow Me On Facebook  ')
    print('')
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://github.com/minhajhossain43')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/picchi.edit.king.sylhet')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def cutter():
    ...
    mmh = input('Put File Name :')
    print(" ")
    minhaj = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+mmh+' | uniq > '+minhaj)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + mmh )
    print(47*'-')
    print("File Saved To :" + minhaj )
    print(47*'-')
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/mmh.txt\n') 
        filepath = input("Put File Name: ")
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back mmh Menu ")
        SSB(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    print(" ")
    minhaj = input('Saving Put File Name:')
    os.system('touch ' +minhaj)
    os.system('sort -r '+mmh+' | uniq > '+minhaj)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + mmh )
    print("New File Saved:" + minhaj )
    print(47*'-')
    input(f"{S} Press Enter To Back SSB Menu ")
    mmh(allkey)       
